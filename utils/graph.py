...
class tempGraph:
    ...
    def closeEnought(self,other,tol):
        ...
        # Values are allowed to be arranged in different order as long as they are
        # Rearrange rows
        t5 = checkIfPerm(self.obsVal, other.obsVal)

        # Obsidx contains only indexes, which will change if reordered
        # However, ga.vals [ga.obsidx] = GB must be kept. Gran Vals 
        # Even so, they will come in a mess.
        # TODO With the increase of values
